...
gamma_dot_0   = 0;              % Assume trim flight path angle rate = 0 [rad/s]
...
disp('Frequency:');
disp(frequency);
StepSize = 0.0001; % Tamanho do passo de simulação
SimTime = 300;    % Tempo total de simulação
x0 = [V0,gamma0,R0,p0,q0,r0,alpha0,beta0,sigma0];
Mt_x=0;
Mt_y=0;
Mt_z=0;